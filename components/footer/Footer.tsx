...
const Footer = () => {
  ...
  return (
    <div className="max-w-[1440px] bg-bbred mx-auto px-6 py-4 ">
      <div className="flex flex-wrap mb-3 gap-3 justify-around sm:justify-between sm:flex-nowrap lg:max-w-[1140px] lg:mx-auto">
        ...
        <div className="flex flex-col text-white text-[14px] justify-evenly">
          <h6>หน้าแรก</h6>
        ...
        <div className="hidden sm:flex flex-col justify-between items-end">
          ...
          <h6 className="text-[14px] text-white">102/197 ถ.เคหะร่มเกล้า</h6>
          <h6 className="text-[14px] text-white">
            แขวงคลองสองต้นนุ่น เขตลาดกระบัง
          </h6>
          <h6 className="text-[14px] text-white">กรุงเทพฯ 10520</h6>
        </div>
      </div>
      ...
      <div className="text-center sm:text-left lg:max-w-[1140px] lg:mx-auto">
        <h6 className="text-white text-[12px] sm:text-[14px] prompt-extralight">
