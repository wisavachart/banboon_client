...
const SectionNewArrival = () => {
  ...
  return (
    <div className="mb-16">
      ...
      {/* SECTION WRAPPER */}
      <div className="rid gap-6 stage1:px-12 stage2:grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 lg:gap-8 md:gap-8 sm:gap-8  lg:px-0 md:px-6 sm:px-6 stage2:px-6">
